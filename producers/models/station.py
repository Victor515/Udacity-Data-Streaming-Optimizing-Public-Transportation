...
class Station(Producer):
    ...
    def __init__(self, station_id, name, color, direction_a=None, direction_b=None):
        ...
        #
        #
        topic_name = f"com.udacity.cta.station.arrivals.{station_name}" # TODO: Come up with a better topic name
        super().__init__(
            topic_name,
    ...
    def run(self, train, direction, prev_station_id, prev_direction):
        ...
        if prev_station_id:
            value["prev_station_id"] = prev_station_id
        if prev_direction:
            value["prev_direction"] = prev_direction

        logger.info("One arrival event is produced:...")
