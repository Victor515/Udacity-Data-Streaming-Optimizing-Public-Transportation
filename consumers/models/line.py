...
class Line:
    ...
    def process_message(self, message):
        ...
        logger.info(f"handle data from topic {message.topic()}")
        ...
        if message.topic() == "com.udacity.cta.stations.table.v1": 
            try:
        ...
        if "com.udacity.cta.station.arrivals" in message.topic():
            logger.info(f"handling arrival data for {message.topic()}")
